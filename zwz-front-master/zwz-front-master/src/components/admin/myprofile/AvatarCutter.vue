<template>
<!--  https://github.com/Momo707577045/vue-avatar-tailor-->
...
<style lang="scss" scoped>
  ...
  .c-left--doing {background-image: url(../../../assets/empty--pure.png);}
  .c-right {
    flex: 1;
    position: relative;
    margin-left: 24px;
    ...
    .preview {
      ...
      .canvas--doing {background-image: url(../../../assets/empty--pure.png);}
    }
    .btn-upload {
      margin-top: 40px;
      width: 100%;
