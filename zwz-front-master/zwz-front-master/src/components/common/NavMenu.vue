<template>
  <el-menu
    ...
    style="width: 100%">
    <el-menu-item v-on:click="changeNo('/')" index="/">
      <router-link :to="{ path: '/'}" style="color: dodgerblue;"><p>首页</p></router-link>
    </el-menu-item>
    <el-menu-item v-on:click="changeNo('/searchOnly')" index="/searchOnly">
      <router-link :to="{ path: '/searchOnly'}" style="color: dodgerblue;"><p>搜索</p></router-link>
    </el-menu-item>
    <el-menu-item  v-on:click="changeNo('/admin')" index="/admin">
