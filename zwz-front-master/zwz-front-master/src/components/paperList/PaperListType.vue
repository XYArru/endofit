        ...
        <el-table style="width: 100%"
          ...
          <el-table-column label="author" prop="username" width="180">
            <template slot-scope="scope">
              <el-button @click="handleClickAuthor(scope.row)" type="text">{{scope.row.author}}</el-button>
            </template>
          </el-table-column>
          <el-table-column label="title" prop="title" width="240">
            <template slot-scope="scope">
              <el-button @click="handleClickTitle(scope.row)" type="text">{{scope.row.title}}</el-button>
            </template>
          </el-table-column>
